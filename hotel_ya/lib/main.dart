...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // the application theme and UI. Then, without quitting the app,
      // try changing colors inside AppTheme and then invoke "hot reload"
      // (save your changes or press "r" if you used
      // the command line to start the app).
      //
      // Notice that the application state is not lost during the reload.
...
class MyHomePage extends StatefulWidget {
  ...
  // (defined below) that contains fields that affect
  // how it looks.
...
class _MyHomePageState
  ...
  void _incrementCounter() {
    ...
    setState(() {
      ...
      // then the build method would not be called again,
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          //
          // By default, it sizes itself to fit
          // its children horizontally,
          // and tries to be as tall as its parent.
          //
          // Column has various properties to control
          // how it sizes itself and how it positions
          // its children.
          //
          // Here we use mainAxisAlignment to center
